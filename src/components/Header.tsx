...
const Header = () => {
  ...
  const handleToggleMenu = () => {
    setIsOpenNavigation((open) => !open);
  };
  return (
    <>
      <header className="relative px-6 py-4  xl:px-8 2xl:px-10 bg-dark-1/90  border-b border-b-stroke-1 backdrop-blur-sm ">
